...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220116_labellecave_c25e1e0549cb58be6856_20220116174312_archive.zip';
	const ARCHIVE_SIZE		 = '83908466';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'c25e1e0-16174312';
    const SECONDARY_PACKAGE_HASH = 'f865a38-16174312';
	const VERSION			 = '1.4.3';
